...
public class UnlitPrism extends UnlitShape {
    public UnlitPrism() {
        super();
    }
    ...
    private void triangle(GL2 gl2, double r, double g, double b) {
        ...
        gl2.glVertex3d(.5, 0, .5);
        gl2.glVertex3d(0, Math.sqrt(.75), .5); //apex
        gl2.glEnd();
    }
    double unit = 0.1;
    ...
    private void square(GL2 gl2, double r, double g, double b) {
        gl2.glColor3d(r, g, b);
        gl2.glBegin(GL2.GL_TRIANGLE_FAN);
        gl2.glVertex3d(-0.5, 0, 0.5);
        gl2.glVertex3d(-0.5, Math.sqrt(.75), 0);
        gl2.glVertex3d(0.5, Math.sqrt(.75), 0);
        gl2.glVertex3d(0.5, 0, .5);
        gl2.glEnd();
    }


    private void prism(GL2 gl2, double size) {
        gl2.glPushMatrix();
        ...
        square(gl2,0, 0, 1); // blue left face
        gl2.glPopMatrix();
        gl2.glPushMatrix();
        gl2.glRotated(270, 0, 1, 0);
        square(gl2,0, 1, 1); // cyan left face
        gl2.glPopMatrix();

        gl2.glPushMatrix();
        gl2.glRotated(90, 1, 0,0);
        gl2.glColor3d(1, 0, 1); //magenta bottom
        gl2.glBegin(GL2.GL_TRIANGLE_FAN);
